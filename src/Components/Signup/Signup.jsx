...
const Signup = () => {
  ...
  const handleProfileUpload = (e) => {
    const imageData = e.target.value; // Get the string data from the input field
    setError((prev) => ({ ...prev, photoUrl: '' }));
    setPhotoName('Uploading...');
  
    // Simulate an upload process
    setTimeout(() => {
      // Here, you can handle the string data as needed
      setRegister((prev) => ({ ...prev, photoUrl: imageData }));
      setPhotoName('Completed.');
    }, 1000);
  };
